...
public:
  ...
  static const ThemeDefinition& getCurrentTheme() { return currentTheme; }

  static void registerTheme(const std::string& name, const ThemeDefinition& theme) { availableThemes[name] = theme; }
